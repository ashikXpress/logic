    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('product.edit', ['product' => $product->id]) }}">
                    @csrf
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="sister_concern">
                                    ...
                                    @foreach($sisterConcerns as $sisterConcern)
                                        <option value="{{ $sisterConcern->id }}" {{ empty(old('sister_concern')) ? ($errors->has('sister_concern') ? '' : ($product->sister_concern_id == $sisterConcern->id ? 'selected' : '')) :
