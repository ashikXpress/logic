...
@section('title')
    Employee Attendance Application In-Charge
@endsection
                    ...
                    <table id="table" class="table table-bordered table-striped ">
                        ...
                        @foreach($applications as $application)
                            <tr>
                                ...
                                <td>{{$application->in_time}}</td>
                                <td>{{$application->out_time}}</td>
                                <td>
                                    <a class="btn btn-info btn-sm" href="{{route("attendance_application_status_in_charge",["attendanceApplication"=>$application->id])}}">Pending</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
