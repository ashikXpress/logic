                    ...
                    <div class="row" id="prinarea" style="margin-top: 30px">
                        <div class="col-md-12">
                            ...
                            <form method="post" action="{{route("promotion_proposal",["candidate"=>$candidate])}}">
                                @csrf
                               <textarea  name="achievement_in_the_present_job" id="editor" class="form-control content-text" rows="10">
                                   {{$proposal->achievement_in_the_present_job?$proposal->achievement_in_the_present_job:
                                   "1. Supervising and implementing the store material management system for update with group wise and machine code wise.
                                    2. Previously the store inventory schedule was yearly now store inventory performed daily and monthly.
                                    3. Now the material sticker changed regularly before that it changed when the sticker ruined.
                                    4. Implementing quarantined register and sticker to find out the incoming material easily.
                                    5. Maintain the incoming and delivery challan information in a register book before that store haven’t this kind of system.
                                    6. Previously some spare parts purchased from foreign were very costly but now the same parts are purchasing locally and the costing is very cheap.
                                    7.    In an excel sheet gathered all the storage material information group wise and machine wise and where the parts are located in the rack."
                                    }}
                                   </textarea>
                                ...
                                <textarea name="additional_responsibilities" class="form-control content-text" rows="10">{{$proposal->additional_responsibilities}}</textarea>
                                <div class="box-header with-border">
                            ...
                            <textarea name="extra_training" class="form-control content-text" rows="3">{{$proposal->extra_training}}</textarea>
                            <div class="box-header with-border">
                            ...
                            <textarea name="promotion_next_higher_position" class="form-control content-text" rows="3">{{$proposal->promotion_next_higher_position}}</textarea>
                            <div class="box-header with-border">
                                <h4>(f). Comments of immediate Supervisor</h4>
                            </div>
                            <textarea name="comments_of_immediate_supervisor" class="form-control content-text" rows="3">{{$proposal->comments_of_immediate_supervisor}}</textarea>
                            <h4>Name.........................     Signature........................ Date.........................</h4>
                            <div class="box-header with-border">
                                <h4>(g). Comments of Next Supervisor  (as applicable)</h4>
                            </div>
                            <textarea name="comments_of_next_supervisor" class="form-control content-text" rows="3">{{$proposal->comments_of_next_supervisor}}</textarea>
                            <h4>Name........................     Signature........................ Date..........................</h4>
                            <div class="box-header with-border">
                                <h4>(h).Comments of Concern Managers (as applicable)</h4>
                            </div>
                            <textarea name="comments_of_concern_managers" class="form-control content-text" rows="3">{{$proposal->comments_of_concern_managers}}</textarea>
                            <h4>Name............................     Signature........................... Date........................</h4>
                            <div class="box-header with-border">
                                <h4>(i). Comments of Division Heads (Director/ GM/DGM/AGM)- as applicable</h4>
                            </div>
                            <textarea name="comments_of_division_head" class="form-control content-text" rows="3">{{$proposal->comments_of_division_head}}</textarea>
                            <h4>Name.............................     Signature............................ Date.......................</h4>
                            <div class="box-header with-border">
                                <h4>(j). Comments of Executive Director (Marketing/ Operations/ Finance) - as applicable</h4>
                            </div>
                            <textarea name="comments_of_executive_director" class="form-control content-text" rows="3"> {{$proposal->comments_of_executive_director}}</textarea>
                            <div class="box-header with-border">
                                <h4>(l). Acknowledgement from Unit HR</h4>
                            </div>
                            <textarea name="acknowledgement_from_unit_hr" class="form-control content-text" rows="3"> {{$proposal->acknowledgement_from_unit_hr}}</textarea>
                            <div class="box-header with-border">
                            ...
                            <textarea name="comments_of_head_of_hr" class="form-control content-text" rows="3">{{$proposal->comments_of_head_of_hr}} </textarea>
