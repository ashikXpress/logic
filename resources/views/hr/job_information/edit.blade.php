...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('job_information.edit',['candidate' => $candidate->id]) }}">
                @csrf
                    ...
                    <div class="form-group {{ $errors->has('from') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-2">
                            <input type="text" class="form-control total-duration" placeholder="Total Duration" id="total-duration"
                                   name="total_duration" value="{{ empty(old('total_duration')) ? ($errors->has('total_duration') ? '' : $jobInformation->total_duration) : old('total_duration') }}" readonly>
