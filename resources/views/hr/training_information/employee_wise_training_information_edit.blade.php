...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('employee_wise_training_information.edit',['trainingInformation' => $trainingInformation->id]) }}">
                @csrf
                    ...
                    <div class="form-group {{ $errors->has('training_title') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="hidden" class="form-control"
                                   name="employee_id" value="{{ empty(old('employee_id')) ? ($errors->has('employee_id') ? '' : $trainingInformation->employee_id) : old('employee_id') }}">
