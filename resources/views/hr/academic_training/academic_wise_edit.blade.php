...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('academic_wise.edit',['academicTraining' => $academicTraining->id]) }}">
                @csrf
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" placeholder="Enter Title"
                                   name="title" value="{{ empty(old('title')) ? ($errors->has('title') ? '' : $academicTraining->title) : old('title') }}">

                            <input type="hidden" class="form-control"
                                   name="employee_id" value="{{ empty(old('employee_id')) ? ($errors->has('employee_id') ? '' : $academicTraining->employee_id) : old('employee_id') }}">
                        ...
                        <div class=" {{ $errors->has('institute') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" placeholder="Enter Institute"
                                       name="institute" value="{{ empty(old('institute')) ? ($errors->has('institute') ? '' : $academicTraining->institute) : old('institute') }}">
                    ...
                    <div class="form-group {{ $errors->has('department') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" placeholder="Enter Department"
                                   name="department" value="{{ empty(old('department')) ? ($errors->has('department') ? '' : $academicTraining->department) : old('department') }}">
                        ...
                        <div class=" {{ $errors->has('passing_year') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" placeholder="Enter Passing Year"
                                       name="passing_year" value="{{ empty(old('passing_year')) ? ($errors->has('passing_year') ? '' : $academicTraining->passing_year) : old('passing_year') }}">
                    ...
                    <div class="form-group {{ $errors->has('result') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" placeholder="Enter Result"
                                   name="result" value="{{ empty(old('result')) ? ($errors->has('result') ? '' : $academicTraining->result) : old('result') }}">
                        ...
                        <div class=" {{ $errors->has('out_off_result') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" placeholder="Enter Out Off Result"
                                       name="out_off_result" value="{{ empty(old('out_off_result')) ? ($errors->has('out_off_result') ? '' : $academicTraining->out_off_result) : old('out_off_result') }}">
                    ...
                    <div class="form-group {{ $errors->has('duration') ? 'has-error' :'' }}">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" placeholder="Enter Duration"
                                   name="duration" value="{{ empty(old('duration')) ? ($errors->has('duration') ? '' : $academicTraining->duration) : old('duration') }}">
...
{{--                                   name="training_title" value="{{ empty(old('training_title')) ? ($errors->has('training_title') ? '' : $academicTraining->training_title) : old('training_title') }}">--}}
...
{{--                                       name="training_institute" value="{{ empty(old('training_institute')) ? ($errors->has('training_institute') ? '' : $academicTraining->training_institute) : old('training_institute') }}">--}}
