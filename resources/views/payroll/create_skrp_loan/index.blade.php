    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('payroll.create.skrp_loan') }}">
                    @csrf
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('skrp_loan_date') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right" id="date" name="skrp_loan_date" value="{{ empty(old('skrp_loan_date')) ? ($errors->has('skrp_loan_date') ? '' : date('Y-m-d')) : old('skrp_loan_date') }}" autocomplete="off">
                                </div>
                                <!-- /.input group -->
