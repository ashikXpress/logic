    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form action="{{ route('payroll.salary_process.report') }}">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            @if($employee_id)
                                <div style="clear: both">
                                    <table class="table table-bordered" style="width:100%; float:left">
                                        ...
                                        <tr>
                                            <td class="text-center">{{ $employee_id->employee_id }}</td>
                                            <td class="text-center">{{ $employee_id->employee->name }}</td>
                                            <td class="text-center">{{ $employee_id->month }}</td>
                                            <td class="text-center">{{ $employee_id->year }}</td>
                                            <td class="text-center">৳ {{ number_format($employee_id->gross_salary,2) }}</td>
                                            <td class="text-center">{{ $employee_id->date->format('j F, Y') }}</td>
                                        </tr>

                                        <tr>
                                            <th class="text-center" colspan="4">Total</th>
                                            <th class="text-center">৳ {{ number_format($employee_id->gross_salary,2) }}</th>
                                        </tr>
                                    </table>
                                </div>
                            @else
