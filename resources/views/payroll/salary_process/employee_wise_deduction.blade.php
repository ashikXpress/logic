...
@section('title')
    Employee Wise Deduction History
@endsection
                ...
                <div class="box-header with-border">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="box-header with-border" style="margin-top: 30px">
                            ...
                            <a style="margin-right: 15px;float: right" href="{{route('payroll.employee_wise_deduction',['candidate' => $candidate->id])}}" class="btn btn-warning active" style="margin-left: 20px">Deduction By Date</a>
                    ...
                    <h3 class="box-title">Filter All Deduction By Date</h3>

                </div>
                <!-- /.box-header -->

                <div class="box-body">
                    <form action="{{ route('payroll.employee_wise_deduction',['candidate' => $employee->id]) }}">
                        <div class="row">
                            <div class="col-md-3">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="adv-table" id="prinarea">
                            <div style="padding:10px; width:100%; text-align:center;">
                                <h2>Logic Group</h2>
                                <h4>Employee Wise Deduction Report</h4>
                            </div>
